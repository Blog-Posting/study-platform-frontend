<template>
  <article
    class="w-full md:w-1/2 xl:w-1/3 flex flex-col p-3"
  >
    <div
      class="overflow-hidden rounded-lg shadow-lg my-2.5"
    >
      <a href="#">
        <img
          alt="Placeholder"
      ...
      <footer
        class="flex items-center justify-between leading-none p-1 md:p-2"
      >
        <a
...
export default defineComponent({
  ...
  props: {
    ...
    description: {
      type: String,
      default:
        'Dynamic Multi DataSource 구현 경험을 공유합니다.',
    },
    tags: {
      type: Array,
      default: () => [
    ...
    userProfile: {
      type: String,
      default:
        'https://avatars.githubusercontent.com/u/53366407?s=460&v=4',
    },
    name: {
      type: String,
      default: 'zumInternet',
